        ...
        <form method="POST" action="{{ route('temas.store') }}">
            ...
            <div>
                ...
                <div class="flex items-center mb-4">
                    <input name="artistas[]" id="artista{{ $artista->id }}" type="checkbox" value="{{$artista->id}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="artista{{ $artista->id }}" class="ms-2 text-sm font-medium text-">{{$artista->nombre}}</label>
                </div>
                @endforeach
            </div>
            ...
            <div>
                ...
                <div class="flex items-center mb-4">
                    <input name="albumes[]" id="album{{ $album->id }}" type="checkbox" value="{{$album->id}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="album{{ $album->id }}" class="ms-2 text-sm font-medium text-">{{$album->titulo}}</label>
                </div>
                @endforeach
            </div>
