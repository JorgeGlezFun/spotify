        ...
        <form method="POST"
            ...
            <div>
                ...
                <x-text-input id="titulo" class="block mt-1 w-full"
                    type="text" name="titulo" :value="old('titulo', $tema->titulo)" disabled
            ...
            <div>
                ...
                <x-text-input id="anyo" class="block mt-1 w-full"
                    type="text" name="anyo" :value="old('anyo', $tema->anyo)" disabled
            ...
            <div>
                ...
                <x-text-input id="duracion" class="block mt-1 w-full"
                    type="text" name="duracion" :value="old('duracion', $tema->duracion)" disabled
