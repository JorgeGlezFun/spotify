...
class ArtistaController extends Controller
{
    ...
    {
        $artista = Artista::findOrFail($id); // Buscar el artista por su ID
        $albumes = $artista->temas()->with('albumes')->get()->pluck('albumes')->flatten();

        return view('artistas.albumes', compact('artista', 'albumes'));
    }
